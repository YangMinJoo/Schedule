...
<div id="content">
  <div class="container">
    <h2 class="title-divider">
      <span>공통<span class="font-weight-normal text-muted">작업일지</span></span>
      <small>Common Work</small>
    </h2>

    <div class="row">
      <!--Blog Grid -->
      <div class="col-sm-12 col-md-9 order-md-4 blog-roll blog-list">
...
echo  '<div class="col-sm-6 col-md-4 grid-item"><div class="blog-post" style="word-break:break-word;"><h4 class="timeline-item-title"><a href="common_blog_view?id=';
echo $list[$i]['id'];
...
?>
      ...
      <!-- end blog -->
    <div class="col-sm-12 col-md-3 order-md-1 sidebar-left d-none d-sm-block">

    <!-- @Element: Search form -->
      <div class="mb-4">
        <div class="btn-group " role="group" aria-label="Write Group">
           <button type="button" class="btn btn-red-dark" onclick="location.href='common_blog_write'"><i class="fa fa-pencil-square-o"></i> 글쓰기</button>&nbsp;
           <button type="button" class="btn btn-red-dark" onclick="location.href='common_blog_list'"><i class="fa fa-list-ul"></i> 목록</button>
         </div>
      </div>
